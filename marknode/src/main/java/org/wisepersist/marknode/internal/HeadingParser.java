...
import org.wisepersist.node.Heading;
import org.wisepersist.parser.InlineParser;
    ...
    public static class Factory extends AbstractBlockParserFactory {
        ...
        public BlockStart tryStart(ParserState state, MatchedBlockParser matchedBlockParser) {
            ...
            if ((matcher = ATX_HEADING.matcher(line.subSequence(nextNonSpace, line.length()))).find()) {
                ...
                // remove trailing ###s:
                String
                    content = ATX_TRAILING.matcher(line.subSequence(newOffset, line.length())).replaceAll("");
