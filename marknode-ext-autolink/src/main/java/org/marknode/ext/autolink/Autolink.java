...
public class Autolink {
   ...
   * The parts of the text outside of links are added to the result without processing.
   *
   ...
   */
  public static String renderLinks(CharSequence input, Iterable<LinkSpan> links,
