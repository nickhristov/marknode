...
import org.marknode.ext.autolink.internal.EmailScanner;
import org.marknode.ext.autolink.internal.Scanner;
import org.marknode.ext.autolink.internal.UrlScanner;
...
public class LinkExtractor {
  ...
  /**
   * Extract the links from the input text. Can be called multiple times with
   * different inputs (thread-safe).
   *
   * @param input the input text, must not be {@code null}
   * @return a lazy iterable for the links in order that they appear in the
  ...
  public static class Builder {
    ...
    /**
     * @param linkTypes the link types that should be extracted
     *                  (by default, all types are extracted)
     * @return this builder
     */
    ...
    /**
     * @param emailDomainMustHaveDot true if the domain in an email address is required
     *                               to have more than one part, false if it can also just
     *                               have single part (e.g. foo@com); true by default
     * @return this builder
     */
    ...
    public LinkExtractor build() {
      ...
      EmailScanner emailScanner =
          linkTypes.contains(LinkType.EMAIL) ? new EmailScanner(emailDomainMustHaveDot) : null;
