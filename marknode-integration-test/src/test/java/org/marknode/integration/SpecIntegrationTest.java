...
import org.marknode.ext.autolink.AutolinkExtension;
import org.marknode.ext.front.matter.YamlFrontMatterExtension;
import org.marknode.ext.gfm.strikethrough.StrikethroughExtension;
import org.marknode.ext.gfm.tables.TablesExtension;
...
public class SpecIntegrationTest extends SpecTestCase {
  ...
  private static final HtmlRenderer
      RENDERER = HtmlRenderer.builder().extensions(EXTENSIONS).percentEncodeUrls(true).build();
  ...
  public void testHtmlRendering(SpecExample example) {
    ...
    if (expectedHtml != null) {
      ...
      super.testHtmlRendering(example);
    }
  }
